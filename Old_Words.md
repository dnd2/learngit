...
Note:
  ...
  * I'd like to order some food, please. 
    ...
    3. order 表示"命令" order + sb. + to + verb 命令某人做某事
...
Note: 
  ...
  * Yes. In the smoking or non-smoking section.
    * 由Yes. Do you want a table in the smoking section or in the none-smoking section? 简化而来 
      - Can I have a window seat, please? (麻烦可以给我靠窗的座位么)
      - Yes. In the smoking or non-smoking section?
  * This way, please.
    * 原句: Follow me (in) this way, please.  
    * in this way(朝这边)在使用时常省略in，说成this way  
  * May I take your order now? 我可以接受您的点菜了吗
    * 餐厅服务员要求客人点菜常用句型:
      ...
      * Would you like to order now sir/ma'am? 您现在想要点菜了吗
        ...
        - Are you ready to order now, sir/ma'am? 您现在要准备点菜了吗，先生/女士
        - Can I have another minute, please? 请再等我一下 
  * How would you like it/your steak? 你的牛排要几分熟 it为代名词，代替上一句已提过的名词steak。
    * 想询问某人食物如何调理时使用的句型:
...
**Substitution**
  ...
  * Do you have a table for two/six?
  * May I have the menu/check/bill?
  * May I take your order now? 我可以接受您的点菜吗
  * Are you ready to order now? 您现在准备要点菜了吗
  * Would you like to order now? 您现在想要点菜了吗
  * How would you like you steak/eggs?
  * How about something to drink?
  * How about going on a picnic tomorrow? 明天去野餐怎么样

**Sentences**
  * Do you have a table ___ four, please?
  * I'd like to ___ a ticket to France, please.
  * May I ___ your order now?
  * How would you ___ your steak?
  * Don't you have ___ to wear?
  * How ___ some music?
  * I need something ___ read.
  * I have ___ to say to you.

**Dialog**
  - Would you like to o___, now?
  - Yes, I'll have a steak.
  - How w___ you like it?
  - Medium r___, please.
  - Would you like anything to d___?
  - I'll h___ a cup of hot tea, please.
  - And would you like any d___?
  - Yes. But can I have a look at the m___ again, please?
...
Note:
  ...
  * clothing 名词 衣服 是不可数名词，英文中，上衣与裤子是分开的，此时表上衣和裤子的名词才是可数名词。
    * 上衣:
  ...
  * clothes 衣服 不可数名词(始终为复数)
    * 除了some clothes，a lot of clothes外，还可用many clothes，many可接复数名词，但不能说many clothing，因为clothing并无复数，但可用much来修饰
      * I want to buy some clothes. 我想去买些衣服
      * He has many clothes. 他有很多衣服 此处不能用clothing需用clothes
      * He doesn't has much clothing. 他没有很多衣服
  * cloth 不可数名词
    *  a piece of cloth 一块布
    *  some cloth 一些布
    *  a lot of cloth 很多布
    *  I always wipe the floor with an old piece of cloth.  
  * Can I have a look at that jacket, please? 请问我可以看下那件夹克么
    * Can I have/take a look at + noun?   我可不可以看一看...呢
      * Can I have a look at your new watch?
      * Sure. Go ahead.
  * What size do you wear? = What size jacket do you wear? 你穿几号的夹克
    * 询问他人穿几号的衣服或裤子等，需用size而不是number
      * What size shoes do you wear?
      * What size socks do you wear?  
  * wear 穿，戴  凡身上穿的或戴的都可用此词
    * She always wears white dresses. 她总喜欢穿白色的洋装
    * Helen wears a hat every day. 海伦每天都戴着一顶帽子
    * Tom wears a red belt to work
    * He is wearing sunglasses because it's a sunny day.  因为出太阳，所以他戴着眼镜
  * extra large  特大号
    * 衣服、裤子等号码可分为 small (小号)，medium (中号)，large (大号)，extra large，通常用大写的"S"，"M"，"L"，"XL"表示。
      * What size shirt do you wear?
      * Large.   
  * Can I try it on?
    * try + 代名词(名词) + on/try on + noun  试穿/戴... 
    * Before I buy this shirt, can I try it on?
  ...
  * I'm looking for a wedding ring. 我正在物色一枚婚戒    
  * Any special brand/kind/type? 要任何特别的品牌/种类/样式吗？
  * Just something simple/plain. 只要样式简单就可以了 
  * I wear size ten shoes. 我穿十码的鞋

**Substitution**
  * Can I have/take a look at that shirt, please?
  * What size shirt/pants do you wear?
  * Can I try it on?
  * Can I try on the watch?
  * I'm looking for a necktie/wedding ring.
  * Any special brand/kind/type? 要任何特别的品牌/种类/样式吗

**Sentences**
  * Use these words to fill the following blank.
    * brand size look cloth for try pair clothes

  * I need a ___ of new pants.
  * Jane is wearing new ___.
  * Do you have a piece of wet ___?
  * Can I have a ___ at your new car?
  * I wear ___ ten shoes.
  * May I ___ on these shoes?
  * What ___ of milk do you drink?
  * My father's old house is ___ sale.

**Dialog**
  - Can I t___ a look at that shirt, please?
  - Sure. Here you are. It's on s___.
  - Really? May I t___ it on?
  - Sorry. You can't. What s___ do you wear?
  - Medium. How m___ is it?
  - It's o___ one hundred dollars.
  - OK. I'll t___ it.
  - Good. H___ you are.
...
### 现在进行时
  ...
  * They're going into the park.
    - man going/into the shop
    - woman going/out of the shop
    - he sitting/beside his mother
    - they walking/across the wall
    - the children jumping/off the branch
    - man standing/between two policeman
    - she sitting/near the tree
    - it flying/under the bridge
    - they sitting/on the grass
...
* She is putting on her coat. => She can put on her coat.
  * Rewrite these sentenses:
    - They are typing these letters.
    - She is making the bed.
    - You are swimming across the rive.
    - We are coming now. 我们现在要来了 => We can come now. 我们现在可以来
    - We are running across the park.
    - He is sitting on the grass.
    - I am giving him some chocolate.
...
### Lesson 47
  ...
  * Do you want a cup? 此处a cup后省略了of coffee。及物动词后要有名称或名词性短语做宾语。like和want都是及物动词。
  * Yes, I do. 是简略回答。完整的是：Yes, I like coffee. do是助动词用来代替动词常用于简略回答中。
  * black coffee 指不加牛奶或咖啡伴侣的咖啡。加牛奶的咖啡叫white coffee.
...
### Lesson 49
  ...
  * I like lamb, but my husband doesn't.
    - doesn't后面省略了like lamb。用but连接的并列句，在后一分句中可以省略于前一句中相同的谓语动词和宾语。
  * To tell you the truth/To tell the truth
  * I don't like chicken either.
    - either 当"也(不)"讲，用在否定句中。肯定句和疑问句可用too。

  * He likes.../But he doesn't like... 他喜欢/但是他不喜欢
    
### Lesson 51

  * Where do you come from?/Where are you from?
  * What's the climate like in your country?  like是介词，它的宾语是what
  * What's it like in summer? 

  * What nationality are they?/Where do they come from?
  * I com from England, but Stella comes from Spain.
...
### Lesson 53
  ...
  * in the North = in the north of England North的第一个字母大写，是因为它单独使用，特指英国北部
...
### Lesson 55
  ...
  * the Sawyers 指索耶一家。姓氏后加-s，前面加定冠词the，用来指一家人，特别是丈夫和妻子。
  * go to school, 上学，school前不带任何冠词。
  * at noon 指"正午"，也叫midday
  * They arrive home early. 本句中home和early都是副词， home做副词表示到家 
  * every day/in the morning/in the afternoon/in the evening/at noon/at night

  * What do they usually do?
  * She washes the dishes every day.
  * The children goes to school in the evening.
  * Their father takes them to school.
  * Mrs. Sawyer stays home at school.
  * She does the housework.
  * She always eats her lunch at noon.

  * What does she do in the morning?
    - She often dusts the cupboard in the morning.
    - She always makes the bed.
  * What do they do in the evening?
    - They sometimes listen to the radio.
  * What does he do every day?
    - He always cleans the blackboard.
  * What do they do at night?
    - They always go to bed early.
  * What does it do every day?
    - It usually drinks some milk.
  
###Lesson 57

  * It is eight o'clock. it常用于指时间，天气，温度或距离。被称作"虚主语"。
  * by car/on foot 状语短语表示方式
  * at the moment 指眼前，"此刻"

  * What's the time?/What time is it? 几点钟
  * They usually... but today, they are... 他们总是...， 但是今天他们正...
    ...
    * He usually washes the dishes at night, but tonight he is washing clothes.
  * What do they ususally do every day?
  ...
  * What is she doing this morning?
    - She is drink coffee this morning.

###Lesson 59

  * Do you want the large size or the small size? 
  * I only have large ones. ones代指pads
  * What else do you want? 您还要什么 What else...? 可以看作是表示疑问的一个短语，意思为：还有什么吗？

  * I don't have any bananas, but I have some peaches.
  * I don't have any coffee, but I have some milk.
  * Do you have any...?
    * Do you have any honey?
      - I don't have any honey, but I have some jams.
    ...
    * Do you have any lettuces?
      - We don't have any lettuces, but we have some cabbages.

###Lesson 61

  * What's the matter with him? 常用于询问人或事物的状况，常作"是否有问题？" "是否有麻烦"讲。
  * feel ill 觉得病了， feel是系动词，ill是表语。注意feel ill和look ill在意思上的区别：前者指自我感觉，后者指外表形象。
  * It's 09754 It's指电话号码是
  * have a bad cold.
  * That's good news. news是不可数名词，不是复数形式
  * Good news? 是省略句,完整为：Is it good news?
  ...
  * I have a cold. He must has a cold.
  ...
  * George/a headache/earache/see a doctor
  * Jane/a toothache/a stomach ache/take some medicine

  ### Lesson 63

  * come upstairs  upstairs为副词
  * you mustn't get up yet.
    - yet 一般用于否定句。
    - get up 英语中动词常与介词或副词连用，组成词组，称为动词短语
  * for another two days.
    - for 引导的表示时间的短语往往可以译作"达"，"计"。 
    - for about two hours each day  每天可达两小时
    - each day 每天
  * keep the room warm

  * Don't... ! 不要...
  * You mustn't...! 你不应该...
    * Rewrite these sentences using Jimmy
    * I mustn't take any aspirins. Jimmy mustn't take any aspirins.
    * I am better now but I mustn't get up yet.
    * I have a cold and I must stay in bed.
    * I can get up for two hours each day.
    * I often read in bed.
  ...
  * make a noise 弄成噪音，发出声响
  
  ### Lesson 65

  * the key to the front door  to the front door是介词短语作定语修饰key
  * What's the time? 
  ...
  * What must you come home? I must come home at one o'clock.
    * When must she go to the library? (1.15)
    * When must you and Sam see the dentist? (3.45)
    * When must you type this letter? (2.00)
    * When must I catch the bus? (3.30)
    * When must you arrive there? (3.00)

### Lesson 67

* 表示某一种商店的短语中，往往可以把shop省略，如the butcher's (shop), the greengrocer's (shop), the hairdresser's (shop), the stationer's (shop), the doctor's (office), my mother's (house)等
* How are you all keeping? 你们身体都好吗
* for the weekend 指整个周末这几天的时间, at the weekend 是强调时间的某一点
* aren't you lucky! 你们真幸运啊!  否定疑问句形式的感叹句，为的是加强语气，尽管形式上否定但却表示强有力的肯定

* Where were you on...? ...你在什么地方
* When were you at...? 你什么时候在...

* I was at church on Sunday.
* I was at office on Monday.
* My son was at school on Tuesday.
* My Wife was at the butcher's on Wednesday.
* She was at the grocer's on Tuesday.
...
* She is airing the room now. She aired it yesterday.
  ...
  * He is boiling some eggs. He boiled some yesterday.
  * We are enjoying our lunch. We enjoyed it yesterday, too.
* What did she do yesterday? She aired the room yesterday.
  * What did they do yesterday? They cleaned their shoes yesterday.
  * What did they do this morning? They sharpened their pencils this monring.
  * What did he do the day before yesterday in the morning? He stayed in bed.
...
* What's wrong with the fashionable shoes? 这些时髦鞋子有什么毛病么?
* Do you have any shoes like these?
  * like these介词短语作定语，修饰shoes
* in fashion 流行的，时髦的 
...
* a lot of "许多"，既可用在可数名词前也可用在不可数名词前，一般用于肯定句
* We haven't got any meat at all.
  * at all 表示"丝毫，一点，根本",有强调的作用
* have got与have 同义
* many,much 可翻译为"许多"，但用法不同：
  * many主要用于疑问句和否定居中，放在可数名词前，如many tomatoes
  * much用于疑问句和否定句中，放在不可数名词前，如much tea, much money
...
* Come upstairs, 其中upstairs表示动作的方向， He's upstairs 则表示他的方位，upstairs可译为"在楼上"
* have 此处后接名词或动词短语，有"进行" "从事"的意思。
  * have a bath
  * have a cigarette
...
* We had a holiday last month. We went for a holday last month.
...
* 现在完成时：
  ...
  2. 表示开始于过去并持续到现在的动作
* Excuse the mass 乱七八糟，请原谅
* have a holiday = go for a holiday
* stay at home, 注意名词前不加任何冠词, 诸如：go home, arrive home的短语中，home是副词
